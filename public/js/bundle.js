...
if (otpInForm) {
  otpInForm.addEventListener('submit', function (e) {
    ...
    (0, _otp.verifyOtp)(otp); // Call verifyOtp function
  });
}
if (signupForm) {
